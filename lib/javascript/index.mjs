...
const generateJavascriptService = async (config, input) => {
    ...
    try {
        ...
        await writeFileIfNotExists(dir, "config", isToJs, getConfigFile({ baseUrl: config.baseUrl || ((_b = (_a = input.servers) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.url) || "" }), config);
