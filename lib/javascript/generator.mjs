...
function resolveParameter(context, parameter) {
    ...
    const resolvedParameter = !$ref
        ? parameter
        : Object.assign(Object.assign({}, (_b = (_a = context.input.components) === null || _a === void 0 ? void 0 : _a.parameters) === null || _b === void 0 ? void 0 : _b[$ref.replace("#/components/parameters/", "")]), { $ref, schema: { $ref } });
    return resolvedParameter.in === "path"
        ? Object.assign(Object.assign({}, resolvedParameter), { required: true }) : resolvedParameter;
}
function mergeParameters(context, pathLevelParams, operationLevelParams) {
...
function createQueryParamsType(context, serviceName, parameters) {
    ...
    const properties = queryParameters === null || queryParameters === void 0 ? void 0 : queryParameters.reduce((prev, { name, schema, $ref, required: _required, description }) => (Object.assign(Object.assign({}, prev), { [name]: Object.assign(Object.assign({}, ($ref ? { $ref } : schema)), { description }) })), {});
    const required = queryParameters === null || queryParameters === void 0 ? void 0 : queryParameters.filter(({ required: isRequired }) => isRequired).map(({ name }) => name);
    context.types.push({
        name: typeName,
        schema: {
            type: "object",
...
function isRequestBodyRequired(context, requestBody) {
    var _a, _b, _c;
    if (!requestBody) {
        return false;
    }
    ...
    return (((_c = (_b = (_a = context.input.components) === null || _a === void 0 ? void 0 : _a.requestBodies) === null || _b === void 0 ? void 0 : _b[getRefName(requestBody.$ref)]) === null || _c === void 0 ? void 0 : _c.required) === true);
}
...
function processEndpointMethod(context, endPoint, method, options, pathLevelParams) {
    ...
    const parameters = mergeParameters(context, pathLevelParams, options.parameters);
    ...
    const requestBodyRequired = isRequestBodyRequired(context, options.requestBody);
